...
@section('content')
                ...
                <div class="col-md-6 col-lg-4 mb-5" data-aos="fade-up">
                    <a href="{{route("reservationpage",$Rooms->id)}}" class="room">
                        ...
                        <div class="p-3 text-center room-info">
                            <h2>{{$Rooms->name}}</h2>
                            <span class="text-uppercase letter-spacing-1">{{$Rooms->roomPrice}} Taka / per night</span>
                        </div>
                    </a>
                </div>
    ...
    <section class="section bg-image overlay" style="background-image: url('{{asset("website_asset/images/hero_4.jpg")}}');">
        <div class="container">
